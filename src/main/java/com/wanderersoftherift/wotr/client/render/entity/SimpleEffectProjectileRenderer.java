...
public class SimpleEffectProjectileRenderer extends GeoEntityRenderer<SimpleEffectProjectile> {
    ...
    @Override
    public void preRender(PoseStack poseStack, SimpleEffectProjectile animatable, BakedGeoModel model, @Nullable MultiBufferSource bufferSource, @Nullable VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int renderColor) {
