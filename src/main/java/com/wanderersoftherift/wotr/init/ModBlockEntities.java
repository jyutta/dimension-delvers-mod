...
public class ModBlockEntities {
    ...
    public static final Supplier<BlockEntityType<RiftMobSpawnerBlockEntity>> RIFT_MOB_SPAWNER = BLOCK_ENTITIES
            .register("rift_mob_spawner", () -> new BlockEntityType<>(RiftMobSpawnerBlockEntity::new, ModBlocks.RIFT_MOB_SPAWNER.get()));
}
