...
{
    public static final ResourceKey<Registry<MapCodec<? extends AbstractEffect>>> EFFECTS_REGISTRY_KEY = ResourceKey.createRegistryKey(WanderersOfTheRift.id("effects"));

    public static final Registry<MapCodec<? extends AbstractEffect>> EFFECTS_REGISTRY = new RegistryBuilder<>(EFFECTS_REGISTRY_KEY).create();
    public static final DeferredRegister<MapCodec<? extends AbstractEffect>> EFFECTS = DeferredRegister.create(
            EFFECTS_REGISTRY_KEY, WanderersOfTheRift.MODID
    );

    public static final Supplier<MapCodec<? extends AttachEffect>> ATTACH_EFFECT = EFFECTS.register(
            "attach_effect", () -> AttachEffect.CODEC);
